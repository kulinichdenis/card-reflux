...
/***/ function(module, exports, __webpack_require__) {
	...
	//Component
	var CartComponent = __webpack_require__(7);
	var ShopComponent = __webpack_require__(8);
	//STORE
	var shopeProduct = __webpack_require__(9);
	var cartStore = __webpack_require__(10);
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { className: "shop" },
	                React.createElement(ShopComponent, { products: this.state.products })
	            ),
	            React.createElement(
	                "div",
	                { className: "cart" },
	                React.createElement(CartComponent, { cart: this.state.item })
	            )
	        );
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!E:\\Anadea\\lesson\\card-reflux\\node_modules\\css-loader\\index.js!E:\\Anadea\\lesson\\card-reflux\\node_modules\\less-loader\\index.js!E:\\Anadea\\lesson\\card-reflux\\src\\stylesheets\\main.less", function() {
			var newContent = require("!!E:\\Anadea\\lesson\\card-reflux\\node_modules\\css-loader\\index.js!E:\\Anadea\\lesson\\card-reflux\\node_modules\\less-loader\\index.js!E:\\Anadea\\lesson\\card-reflux\\src\\stylesheets\\main.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var CartProductComponent = __webpack_require__(39);
	...
	var CartComponent = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var SelectCarts = this.props.cart.map(function (elem, index) {
	            return React.createElement(CartProductComponent, { product: elem, key: index });
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ProductComponent = __webpack_require__(37);
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                this.props.products.map(function (elem, index) {
	                    return React.createElement(ProductComponent, { product: elem, key: index, on: click, up: update });
	                })
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = Reflux.createStore({
	    ...
	    update: function update(code, value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductComponent = React.createClass({
	    ...
	    userOnClick: function userOnClick(event) {
	        event.preventDefault();
	        actions.add(this.props.product);
	    },
	    render: function render() {
	        return React.createElement(
	            "div",
	            ...
	            React.createElement(
	                "a",
	                { href: "#", className: "col-md-4 add-to-cart", "data-product": this.props.product.code },
	                React.createElement("img", { onClick: this.userOnClick, src: this.props.product.img, alt: this.props.product.title })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(12);
	var Actions = Reflux.createActions(["update", "delete", "add"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartProductComponent = React.createClass({
	    ...
	    handlerValue: function handlerValue(event) {
	        event.preventDefault();
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: "col-md-1" },
	                    React.createElement("input", { "data-product": this.props.product.id, type: "number", min: "1", className: "form-control",
	                        value: value, onChange: this.handlerValue })
	                ),
	                React.createElement("a", { "data-product": this.props.product.i, href: "#", className: "delete fui-cross", onClick: this.deleteItem })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.StoreMethods = __webpack_require__(187);

	exports.createAction = __webpack_require__(182);

	exports.createStore = __webpack_require__(183);

	exports.connect = __webpack_require__(184);

	exports.connectFilter = __webpack_require__(185);

	exports.ListenerMixin = __webpack_require__(186);

	exports.listenTo = __webpack_require__(189);

	exports.listenToMany = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(191),
	    Reflux = __webpack_require__(46),
	    Keep = __webpack_require__(192),
	    mixer = __webpack_require__(267),
	    allowed = {preEmit:1,shouldEmit:1},
	    bindMethods = __webpack_require__(268);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(46),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slice = Array.prototype.slice,
	    _ = __webpack_require__(191),
	    createStore = __webpack_require__(183),
	    strategyMethodNames = {
	        strict: "joinStrict",
	        first: "joinLeading",
	        last: "joinTrailing",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Promise = __webpack_require__(319);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(334);
	var getMarkupWrap = __webpack_require__(331);
	var invariant = __webpack_require__(53);
